...
\author{Sergio Garcia Manogil Fernandez}                			% author's name
...
%%% Style fixes
\captionsetup{justification=justified, singlelinecheck=false} % Even short captions begin on left.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   % \include{front-matter/acknowledgments} % include the acknowledgments
    ...
    %\hypersetup{linkcolor=blue!80!black} % SG: Avoid link color in ToC
    \newpage
