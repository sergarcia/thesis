...
\chapter{Development of an updated genome-scale metabolic model of \textit{Clostridium thermocellum} and its application for integration of multi-omics datasets} \label{ch:ctherm}
% Can add: "and modular cell design"
...
ii) The reaction deoxyribose-phosphate aldolase (DRPA) was removed to ensure correct lethality prediction of the \ko{hydG,ech,pfl} as well as the correct prediction of growth recovery in this mutant by addition of external electron sinks such as sulfate or ketoisovalerate (Table~\ref{tab:mutants}). DRPA  was identified as the best target for removal from a systematic single-reaction deletion analysis (Section \ref{sec:deletion_analysis}).
...
%use avoid erroneous predictions that could lead to futile experimental efforts when
...
\begin{figure}[h]
    %\caption{(\textbf{a.}) Training of GAM and NGAM parameters. (\textbf{b.}) Comparison of growth prediction error between iCBI655 and iAT601.  (\textbf{c.}) Error in growth predictions, from \textbf{b.}, under batch and chemostat conditions.}
...
\begin{figure}[h]
    \caption[Quality assesement scores for iCBI655 model]{Scores provided by the quality control tool Memote\citep{lieven2018} for iCBI655 and iML1515 (overall score indicated in the legend).}%Annotation fields indicate detailed specification of model components critical for model reusability, while the Consistency field verifies biochemical consistency properties such as mass and charge balance of model reactions.}
    \centering
    \includegraphics[width=0.6\textwidth, keepaspectratio]{memote_scores.png}
    \label{fig:memote}
\end{figure}
...
\begin{figure}[h]
    %\caption{(\textbf{a.}) Multi-scale data integration and analysis procedure. (\textbf{b.}) Mapping of proteomics data for the \ko{hydG,ech} case study to model reactions. (\textbf{c.}) Correlation between measured fold changes and simulated fold changes (pFBA in blue and FVA in orange) for all 70 consistent reactions of the \ko{hydG, ech} case study.}
...
\begin{figure}[p]
    ...
    \centering
    \includegraphics[width=0.95\textwidth, keepaspectratio]{proteomics_fc_map.png}
    \label{fig:map}
\end{figure}
...
ii) increased translation of all three malate shunt enzymes and decreased translation of the alternative route PPDK; %(Figure~\ref{fig:map}b});
...
%This research was funded by The Center of Bioenergy Innovation (CBI), U.S. Department of Energy Bioenergy Research Center supported by the Office of Biological and Environmental Research in the DOE Office of Science. The funders had no role in the study design, data collection and analysis, decision to publish, or preparation of the manuscript.
%
% Bibliography
%\singlespace
%\printbibliography
%
%% Re-define margins for figures
%\newpage
%\newgeometry{left=1in,right=1in,top=1in,bottom=1in}

%\section*{Abbreviations}
% \todo[inline]{Include reactions, metabolites, etc, used throughout the text. is this needed?}
%
