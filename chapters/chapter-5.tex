...
\disclose{Harnessing natural modularity of cellular metabolism to design a modular chassis cell for a diverse class of products by using goal attainment optimization. Garcia, S., and Trinh, C. T. In review, 2019} Supplementary Files S1 and S2 are provied as attachments.
...
\begin{figure}[p]
    ...
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{modcell.png}
    \label{fig5:modcell}
\end{figure}
%}
...
\begin{figure}[p]
    ...
    \centering
    \includegraphics[height=.75\textheight,keepaspectratio]{candidate-reactions.png}
